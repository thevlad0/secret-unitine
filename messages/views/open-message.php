                ...
                <form id="new-message-form" class="annotatable">
                    ...
                    <div>
                        <input type="text" id="receivers" name="receivers" class="message-header"
                            placeholder="Получатели" value="$_SESSION['message']['topic']" />
                    </div>
                    <div>
                        <input type="text" id="topic" name="topic" class="message-header" placeholder="Тема" value="$_SESSION['message']['topic']" />
                    </div>
                    <div>
